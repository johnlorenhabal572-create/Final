  ...
  const getNavLinks = () => {
    ...
    if (user.role === 'admin') {
      return [
        ...
        { name: 'Customer Payment', path: '/customer-payment', icon: <CreditCard size={20} /> },
                ...
                {!user ? (
                  <>
                    ...
                    <Link 
                      ...
                      onClick={() => setIsSidebarOpen(false)}
                    >
                      <span className="text-gray-400 group-hover:text-primary transition-colors"><Receipt size={20} /></span>
                      My Bill
                    </Link>
                  </>
                ) : (
                  <Link 
                    ...
                    onClick={() => setIsSidebarOpen(false)}
                  >
                    <span className="text-gray-400 group-hover:text-primary transition-colors"><Users size={20} /></span>
                    Account Management
                  </Link>
                )}
              </div>
