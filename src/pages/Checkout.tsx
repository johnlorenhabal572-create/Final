  ...
  return (
    <div className="container mx-auto p-6 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-sm border">
        ...
        <div className="mb-4">
          <label className="block text-gray-700 mb-2 font-medium">Facebook Profile Link</label>
          <input 
            type="text" 
            name="facebook" 
            value={formData.facebook}
            placeholder="eg. fb.com/username"
            required 
            onChange={handleChange} 
            className="w-full border border-gray-300 p-2 rounded focus:outline-none focus:border-primary" 
          />
        ...
        <div className="mb-4">
          ...
          <input 
            ...
            placeholder="eg. 123 Street, Brgy. Central"
            required 
            onChange={handleChange} 
            className="w-full border border-gray-300 p-2 rounded focus:outline-none focus:border-primary" 
          />
        ...
        <div className="mb-4">
          <label className="block text-gray-700 mb-2 font-medium">Landmark</label>
          <input 
            type="text" 
            name="landmark" 
            value={formData.landmark}
            placeholder="eg. Near the Church"
            required 
            onChange={handleChange} 
            className="w-full border border-gray-300 p-2 rounded focus:outline-none focus:border-primary" 
          />
